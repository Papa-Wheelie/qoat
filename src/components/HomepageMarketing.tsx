...
function WhyTrustSection() {
  const items = [
    ...
    {
      heading: "Real quotes, not estimates",
      text: "Benchmarks come from actual uploaded quotes by Australian homeowners — not modelled estimates or sponsored data.",
      href: null,
      icon: (
        <svg
          width="20"
...
export default async function HomepageMarketing() {
  const [topCategoryResults, exampleQuote] = await Promise.all([
    Promise.all(
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-on-surface-variant leading-relaxed max-w-md">
              Upload a trade or supplier quote and get an instant iron triangle analysis — price, reputation, and timeframe — backed by AI and real Australian data.
            </p>
            <div className="space-y-3 pt-2">
              ...
              <p className="text-xs text-on-surface-variant">Free · Takes about a minute</p>
            </div>
          </div>
