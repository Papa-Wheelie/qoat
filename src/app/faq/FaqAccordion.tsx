  ...
  return (
    ...
    >
      <button
        ...
        onClick={onToggle}
        className="w-full flex items-center justify-between gap-4 px-5 py-4 text-left hover:border-[#C6C6C6] transition-colors rounded-[12px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
      >
...
export default function FaqAccordion({ groups }: { groups: Group[] }) {
  // Track open items by their global index
