...
export const CATEGORIES: TopCategory[] = [
  ...
  },
  {
    ...
    name: "Automotive",
    subcategories: [
      { slug: "auto-general-repairs",   name: "General repairs" },
      { slug: "auto-servicing",         name: "Servicing" },
      { slug: "panel-beating",          name: "Panel beating & smash repair" },
      { slug: "tyres-wheels",           name: "Tyres & wheels" },
      { slug: "auto-detailing",         name: "Detailing" },
      { slug: "auto-electrical",        name: "Auto electrical" },
      { slug: "mechanical-inspection",  name: "Mechanical inspection (pre-purchase)" },
    ],
  },
  {
    ...
    subcategories: [
      ...
      { slug: "income-protection",  name: "Income protection" },
      { slug: "mortgage-broker",    name: "Mortgage broker" },
  ...
  },
  {
    ...
    name: "Other services",
    subcategories: [
      { slug: "interior-cleaning",    name: "Cleaning (interior)" },
      { slug: "removalists-moving",   name: "Removalists & moving" },
      { slug: "storage",              name: "Storage" },
      { slug: "skip-waste-removal",   name: "Skip / waste removal" },
      { slug: "event-hire",           name: "Event hire" },
